...
def resolve_tts_model_class() -> Tuple[Optional[Any], Optional[str]]:
    ...
    try:
        ...
        # tts_src/utils/tts_resolver.py -> NachoBot-TTS-Adapter/configs/base.toml
        ...
        module_name = f"tts_src.plugins.{target_plugin}"
        try:
            ...
            if hasattr(module, "TTSModel"):
                ...
                module_name = f"tts_src.plugins.{target_plugin}.tts_model"
                module = importlib.import_module(module_name)
                return module.TTSModel, None
