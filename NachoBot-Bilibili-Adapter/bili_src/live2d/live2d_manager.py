...
class Live2DManager:
    ...
    def extract_json_emotion_from_text(self, text: str) -> Tuple[str, Optional[str], Optional[str]]:
    ...
    def execute_extracted_live2d_action(self, emotion: Optional[str], action: Optional[str]) -> None:
